...
// Retrieve image name from command line
// var fullName = process.argv[2];
var fullName = '/Users/craig/Downloads/caffeine/backups/37 (headless)/pod.image'
if(!fullName) {
	console.error("No image name specified.");
	console.log("Usage (simplified): " + path.basename(process.argv0) + " " + path.basename(process.argv[1]) + " <Squeak image filename>");
	process.exit(1);
}
