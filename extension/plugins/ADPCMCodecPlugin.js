...
window.module("users.bert.SqueakJS.plugins.ADPCMCodecPlugin").requires("users.bert.SqueakJS.vm").toRun(function() {
"use strict";    
...
window.Squeak.registerExternalModule("ADPCMCodecPlugin", {
