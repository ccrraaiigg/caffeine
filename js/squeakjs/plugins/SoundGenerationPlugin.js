...
window.module("users.bert.SqueakJS.plugins.SoundGenerationPlugin").requires("users.bert.SqueakJS.vm").toRun(function() {
"use strict";
...
window.Squeak.registerExternalModule("SoundGenerationPlugin", {
